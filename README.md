...
plain-text file that contains your preferred passphrase at
`/tmp/passphrase.key`.
...
> Alternatively, you could use build the provided installation media and use
> the included disko package for disk partitioning.
